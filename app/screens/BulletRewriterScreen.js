  ...
  const handleRewrite = async () => {
    if (!bullet.trim()) {
      Alert.alert(
        ...
        isTurkish
          ? "Lütfen maddeyi yaz."
          : "Please enter a bullet point first."
      );
      return;
    }
    ...
    if (bullet.length > 500) {
      Alert.alert(
        isTurkish ? "Uyarı" : "Warning",
        isTurkish
          ? "Madde çok uzun. En fazla 500 karakter olmalı."
          : "Bullet is too long. Max 500 characters."
      );
      return;
    }
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.label, { color: theme.textSecondary }]}>
        {isTurkish
          ? "Mevcut maddeyi yaz veya yapıştır:"
          : "Type or paste your existing bullet:"}
      </Text>
      ...
      <View style={{ position: "relative" }}>
        <TextInput
          ...
          placeholder={
            isTurkish
              ? "Ör: Müşteri memnuniyetini artırmak için süreçleri iyileştirdim..."
              : 'e.g. Improved processes to increase customer satisfaction...'
          }
            ...
            <TouchableOpacity
              ...
              style={[
                styles.toneChip,
                {
                  ...
                  backgroundColor: active ? "#1d4ed8" : theme.bgCard,
                },
              ]}
            >
              <Text
      ...
      <TouchableOpacity
        style={[
          styles.button,
          { backgroundColor: "#2563eb", opacity: loading ? 0.7 : 1 },
        ]}
